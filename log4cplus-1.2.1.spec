...
License  : Apache-2.0
Requires: log4cplus-1.2.1-lib = %{version}-%{release}
...
%package dev
Summary: dev components for the log4cplus-1.2.1 package.
Group: Development
Requires: log4cplus-1.2.1-lib = %{version}-%{release}
Provides: log4cplus-1.2.1-devel = %{version}-%{release}
Requires: log4cplus-1.2.1 = %{version}-%{release}

%description dev
dev components for the log4cplus-1.2.1 package.


%package lib
Summary: lib components for the log4cplus-1.2.1 package.
Group: Libraries

%description lib
lib components for the log4cplus-1.2.1 package.


%prep
%setup -q -n log4cplus-1.2.1
cd %{_builddir}/log4cplus-1.2.1
